...
parser.add_argument('--ckpt_path', type=str, default='best_ckpt/ST.pth',
...
parser.add_argument('--feature_modal', type=str, default='combine',
                        help='features from different input, options contain rgb, flow , combine')
# settings for model MSTR
parser.add_argument('--Vitblock_num', type=int, default=2, help='1-8')
